                    ...
                    <form:form method="post" action="./create" modelAttribute="product" enctype="multipart/form-data">
                        ...
                        <div class="caption-full">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <form:label path="category.id">Danh mục</form:label><br/>
                                        <form:select path="category.id">
                                    <option value="-1">Select a type
                                    </option>
                                    <c:forEach items="${listCate}" var="item">
                                        <c:choose>
                            ...
                            <input type="submit" class="btn btn-outline-info btn-block" value="Confirm">
                        </form:form>
                        <a href="../home/index" class="btn btn-outline-info btn-block">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
